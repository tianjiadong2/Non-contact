...
sjcs_201901 = np.load('./sjcs_201901_yixing.npy',allow_pickle=True).item()
sjcs_201902 = np.load('./sjcs_201902_yixing.npy',allow_pickle=True).item()
sjcs_201903 = np.load('./sjcs_201903_yixing.npy',allow_pickle=True).item()
sjcs_201904 = np.load('./sjcs_201904_yixing.npy',allow_pickle=True).item()
sjcs_201905 = np.load('./sjcs_201905_yixing.npy',allow_pickle=True).item()
sjcs_201906 = np.load('./sjcs_201906_yixing.npy',allow_pickle=True).item()
sjcs_201907 = np.load('./sjcs_201907_yixing.npy',allow_pickle=True).item()
sjcs_201908 = np.load('./sjcs_201908_yixing.npy',allow_pickle=True).item()
sjcs_201909 = np.load('./sjcs_201909_yixing.npy',allow_pickle=True).item()
sjcs_201910 = np.load('./sjcs_201910_yixing.npy',allow_pickle=True).item()
sjcs_201911 = np.load('./sjcs_201911_yixing.npy',allow_pickle=True).item()
sjcs_201912 = np.load('./sjcs_201912_yixing.npy',allow_pickle=True).item()
...
np.save('./sjcs_nian_yixing.npy', sjcs_nian)  # 持久化
