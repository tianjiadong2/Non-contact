...
sjcs_201901 = np.load('./sjcs_201901.npy',allow_pickle=True).item()
sjcs_201902 = np.load('./sjcs_201902.npy',allow_pickle=True).item()
sjcs_201903 = np.load('./sjcs_201903.npy',allow_pickle=True).item()
sjcs_201904 = np.load('./sjcs_201904.npy',allow_pickle=True).item()
sjcs_201905 = np.load('./sjcs_201905.npy',allow_pickle=True).item()
sjcs_201906 = np.load('./sjcs_201906.npy',allow_pickle=True).item()
sjcs_201907 = np.load('./sjcs_201907.npy',allow_pickle=True).item()
sjcs_201908 = np.load('./sjcs_201908.npy',allow_pickle=True).item()
sjcs_201909 = np.load('./sjcs_201909.npy',allow_pickle=True).item()
sjcs_201910 = np.load('./sjcs_201910.npy',allow_pickle=True).item()
sjcs_201911 = np.load('./sjcs_201911.npy',allow_pickle=True).item()
sjcs_201912 = np.load('./sjcs_201912.npy',allow_pickle=True).item()
...
np.save('./sjcs_nian.npy', sjcs_nian)  # 持久化
