...
sjcs_201901 = np.load('./sjcs_201901_shiyou.npy',allow_pickle=True).item()
sjcs_201902 = np.load('./sjcs_201902_shiyou.npy',allow_pickle=True).item()
sjcs_201903 = np.load('./sjcs_201903_shiyou.npy',allow_pickle=True).item()
sjcs_201904 = np.load('./sjcs_201904_shiyou.npy',allow_pickle=True).item()
sjcs_201905 = np.load('./sjcs_201905_shiyou.npy',allow_pickle=True).item()
sjcs_201906 = np.load('./sjcs_201906_shiyou.npy',allow_pickle=True).item()
sjcs_201907 = np.load('./sjcs_201907_shiyou.npy',allow_pickle=True).item()
sjcs_201908 = np.load('./sjcs_201908_shiyou.npy',allow_pickle=True).item()
sjcs_201909 = np.load('./sjcs_201909_shiyou.npy',allow_pickle=True).item()
sjcs_201910 = np.load('./sjcs_201910_shiyou.npy',allow_pickle=True).item()
sjcs_201911 = np.load('./sjcs_201911_shiyou.npy',allow_pickle=True).item()
sjcs_201912 = np.load('./sjcs_201912_shiyou.npy',allow_pickle=True).item()
